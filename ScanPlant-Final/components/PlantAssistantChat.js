...
const PlantAssistantChat = ({ navigation }) => {
        ...
        <View style={styles.chatContainer}>
          <View style={styles.chatHeader}>
            <View style={styles.headerContent}>
              ...
              <View>
                <Text style={styles.headerTitle}>Especialista Botânico</Text>
...
// Componente do botão flutuante - usado para referência caso precise readicioná-lo
/*
